...
public class HomeController {
	...
	@PostMapping(value="/checkLogin/{username}/{password}")
	public String checkLogin(@PathVariable(name="username")String username,@PathVariable(name="password")String password)
	{
		...
		{
			return "Please Check Login Creaditional";
		}
	}
